...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        if platform.system() == "Windows":
            ...
            build_args += ['--', '-j%s' % str(num_jobs), 'pyHell']
...
setup(
    name='pyHell',
    version='0.1',
    author='HellSolver Team',
    author_email='utilforever@gmail.com',
    description='Helltaker simulator with some reinforcement learning',
    long_description='',
    ext_modules=[CMakeExtension('pyHell')],
